  ...
  return (
    <MaxWidthWrapper className="grid grid-cols-1 lg:grid-cols-2 p-2 mt-5">
      ...
      <div className="max-w-xl">
        <h1 className="text-gradient2 uppercase font-bold text-3xl mb-2 text-center lg:text-left">About us</h1>
        ...
        <Button onClick={() => router.push('/about-us')} className="uppercase text-gradient2 border border-[#E26F2E] bg-transparent">Read more</Button>
      </div>
    </MaxWidthWrapper>
  )
}
